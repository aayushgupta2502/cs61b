...
class Move {
    ...
    private Move(int col0, int row0, int col1, int row1) {
        ...
        _isExtend = Math.abs(_fromIndex - _toIndex) == 1
                || Math.abs(_fromIndex - _toIndex) == 10
                || Math.abs(_fromIndex - _toIndex) == 11
                || Math.abs(_fromIndex - _toIndex) == 12;
        _isJump = !_isExtend
                && Math.abs(_fromIndex - _toIndex) == 2
                || Math.abs(_fromIndex - _toIndex) == 9
                || Math.abs(_fromIndex - _toIndex) == 13
                || Math.abs(_fromIndex - _toIndex) == EXTENDED_SIDE * 2 - 2
                || Math.abs(_fromIndex - _toIndex) == EXTENDED_SIDE * 2 - 1
                || Math.abs(_fromIndex - _toIndex) == EXTENDED_SIDE * 2
                || Math.abs(_fromIndex - _toIndex) == EXTENDED_SIDE * 2 + 1
                || Math.abs(_fromIndex - _toIndex) == EXTENDED_SIDE * 2 + 2;
    }
